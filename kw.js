...
✅ WAJIB MENGGUNAKAN JASA ADMIN *WAR STORE* SUPAYA TERHINDAR DARI PENIPUAN  !
✅ BE SMART BUYYER`
reply(teks938)
}
break
case "payment": {
teks137 = "*🔰PAYMENT ZIRO-MD⚡*\n```SEMUA PEMBAYARAN\nWAJIB MENYERTAKAN BUKTI TRANSFER !!```\n*_( ALL TRX NO REFF‼️ )_*\n\n*• GOPAY 💳 :* _https://i.ibb.co/7V3YH24/GOPAY.jpg_\n```( ATAS NAMA: Alvino Refaldy )```\n\n*• DANA 💳 :*```081228070013\n( ATAS NAMA: Sri Maryani )```\n\n*• OVO 💳 :*```081227508166\n( ATAS NAMA: Massz AL )```\n\n*• SHOPPE PAY 💳 :*```081228070013\n( ATAS NAMA: Mz.Alvin )```\n\n*• QRIS 💳 :*_https://i.ibb.co/HB0mZZF/QRIS.png_\n```( ATAS NAMA: ALVIN JB )```\n\n*© Ziro-MD OFFICIAL ⚡*"
reply(teks137)
}
break
case "donasi": {
...
⏣ ɢᴏᴘᴀʏ: [ -]
⏣ ᴛᴇʟᴋᴏᴍsᴇʟ:  [ -]
⏣ ǫʀɪs ᴀʟʟ ᴘᴀʏ : [ https://i.ibb.co/HB0mZZF/QRIS.png ]
...
Sewa Bot ? Hubungi Admin Untuk Nego Wa.me/6283876153812`
